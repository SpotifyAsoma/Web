...
function HeroContent() {
  ...
  return (
    <div className="text-center max-w-4xl mx-auto">
      <div className="inline-flex flex-wrap items-center justify-center gap-2 px-4 py-2 rounded-full mb-8"
        style={{
...
function MobileLayout() {
  return (
    <section className="relative overflow-hidden" id="hero">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 pt-28 pb-8">
        <HeroContent />
      </div>
