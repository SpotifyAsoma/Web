...
function Coin({ product, index, total, mouse }: CoinProps) {
  ...
  const coinGeometry = new THREE.CylinderGeometry(2.2, 2.2, 0.5, 32);
  const edgeGeometry = new THREE.TorusGeometry(2.2, 0.15, 16, 32);
...
export function HeroCanvas() {
  return (
    <div className="relative w-full h-full min-h-[600px]" style={{ touchAction: 'none' }}>
      <Canvas
